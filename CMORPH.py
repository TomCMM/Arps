...
#------ Input ARPS/
InputDirPath='/home2/sim/out300m_V29_netcdf/'
fn = 'r300m.net000000'
...
#------ Output
OutDirPath='/home/thomas/PhD/arps/res/fig_14-02-14/CMORPH/V29/' 
...
Hourcum=1800#Number of hours of accumulation in Second
UTC=0
#====================
#	OPEN FILE CMORPH
#===================
...
for  cpt,fn in enumerate(Arpsfiles):
	...
	title=('Accumulated Precipitation from ARPS (mm/h)')
	plt.title(title)
